...
<ul>
  ...
  <li>Containerization & Deployment (Docker, Nginx, YAML)</li>
  <li>Full-Stack Web Development</li>
  <li>Cross-platform apps (Flutter, Tauri)</li>
  <li>Software Testing & QA</li>
  <li>Systems & Low-level Programming (C, C++)</li>
...
<div align="left">
  ...
  <!-- JavaFX uses Java icon -->
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg" height="40" title="JavaFX" />
  <img width="12" />
